...
/// App. Unsere Grafiken liegen aber im **Modul**-Bundle der GameCore-Library
/// (`GameCoreResources.bundle`, Unterordner `Art`). Außerdem soll GameCore plattformneutral bleiben
/// (macOS **und** iOS) – deshalb
...
enum ArtTexture {
    ...
    static func load(_ name: String) -> SKTexture? {
        ...
        guard let url = GameCoreResources.bundle.url(forResource: name, withExtension: "png", subdirectory: "Art"),
