...
- **v0.12.1 Release entscheiden**: Entscheiden, ob v0.12.1 (Replay-Szenengrössen-Fix + `--render-video mp4`) nach GitHub gepusht / als notarisiertes Release rausgebracht wird. Aktuell nur lokal + minipc (Commits `1866b62`, `a9d2126`). Bestehende Replays rendern bereits korrekt; ein Release ist nur nötig, damit der installierte App-Build künftig die Szenengrösse direkt mitaufnimmt. (ex-theplan #223)
